...
import (
	...
	"gobook-basic-go/gobook/internal/service"
	"gobook-basic-go/gobook/internal/web"
	"gobook-basic-go/gobook/internal/web/middleware"
...
func initDB() *gorm.DB {
	db, err := gorm.Open(mysql.Open("root:root@tcp(localhost:13316)/gobook"))
	if err != nil {
		panic(err)
	}
